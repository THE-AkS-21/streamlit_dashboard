...
#     <script>
#         window.__agGridEnterpriseLicense = "{license_Key}";
#     </script>
# """, height=0)
#
...
#         pivotPanelShow='collapsed',  # Enables pivot panel
...
#         chartThemes=["ag-material", "ag-pastel", "ag-vivid"],
#         chartToolbarItems=["chartData", "chartSettings", "chartDownload", "chartUnlink"],
#         # enableChartToolPanels=True,  # show chart tool panel
#         paginationPageSize=page_size,
#         suppressRowClickSelection=False,
#         rowSelection={"type": "multiple"},  # 'single' or 'multiple'
#         sideBar=True,  # Shows sidebar with filters, columnsx
